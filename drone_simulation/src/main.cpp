...
{
    std::cout << "Usage:\n"
              << "  drone_simulation [data_dir] [config_file] [ammo_file]\n\n"
              << "Arguments:\n"
              ...
              << "  drone_simulation ./data config.json ammo.json\n"
              << "  drone_simulation /etc/drone custom_config.json custom_ammo.json\n\n"
              << "Options:\n"
